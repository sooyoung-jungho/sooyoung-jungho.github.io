                    ...
                    <div className="flex min-h-full items-center justify-center p-4">
                        ...
                        >
                            <Dialog.Panel className="relative w-full max-w-md transform overflow-hidden rounded-2xl bg-transparent p-6 text-left align-middle transition-all">
                                ...
                                <button
                                    onClick={onClose}
                                    className="absolute right-6 top-6 p-1.5 rounded-full hover:bg-white/10"
                                >
                                ...
                                <div className="mt-12 mb-8">
                                    <h2 className="text-white text-lg mb-4 border-b border-white/20 pb-2">
                                        <span className="font-medium mr-2">신랑측</span>
                                        <span className="text-white/60 text-sm">GROOM</span>
                                    </h2>
                                ...
                                <div>
                                    <h2 className="text-white text-lg mb-4 border-b border-white/20 pb-2">
                                        ...
                                        <span className="text-white/60 text-sm">BRIDE</span>
                                    </h2>
                                    <div className="space-y-4">
