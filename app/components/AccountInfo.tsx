                ...
                <div className={`flex justify-center w-full transition-all duration-300 ease-in-out overflow-hidden ${showGroomAccount ? 'max-h-[1000px] opacity-100' : 'max-h-0 opacity-0'
                    ...
                    <div className="w-4/5 space-y-3">
                        ...
                        <div className="p-4 bg-white rounded-lg shadow-sm space-y-3">
                            <div className="grid grid-cols-[1fr_100px] gap-2 items-center">
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500">신한 110-354-833731</p>
                                </div>
                        ...
                        <div className="p-4 bg-white rounded-lg shadow-sm space-y-3">
                            <div className="grid grid-cols-[1fr_100px] gap-2 items-center">
                                <div>
                                    <p className="text-sm text-gray-400">예금주: 현종권</p>
                                    <p className="text-sm text-gray-500">하나 800-910041-89907</p>
                                </div>
                                <div className="flex flex-col items-center gap-2">
                                    <button
                        ...
                        <div className="p-4 bg-white rounded-lg shadow-sm space-y-3">
                            <div className="grid grid-cols-[1fr_100px] gap-2 items-center">
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500">신한 110-513-232621</p>
                                </div>
                                <div className="flex flex-col items-center gap-2">
                                    <button
                        ...
                        <div className="p-4 bg-white rounded-lg shadow-sm space-y-3">
                            <div className="grid grid-cols-[1fr_100px] gap-2 items-center">
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500">토스 1000-4828-5857</p>
                                </div>
                                <div className="flex flex-col items-center gap-2">
                                    <button
                        ...
                        <div className="p-4 bg-white rounded-lg shadow-sm space-y-3">
                            <div className="grid grid-cols-[1fr_100px] gap-2 items-center">
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500">우리 1002-062-456376</p>
                                </div>
                                <div className="flex flex-col items-center gap-2">
                                    <button
